/* $Id: GameDataModel.java,v 1.9 2004/03/19 14:11:01 root777 Exp $ */
/***************************************************************************
...
//
  ...
  public String dumpToString()
  {
    ...
    if(spectators!=null&&spectators.length>0)
    {
      ...
      ret+=middle;
      ret+="|"+setStringWidth(setStringWidth("Name",' ',25)+setStringWidth("Fame",' ',6)+setStringWidth("Message",' ',49),' ',80)+"|\n";
      ret+=middle;
      for (int i = 0; i < spectators.length; i++)
      {
        try
        {
          ...
          ret+="|"+setStringWidth(setStringWidth(name,' ',25)+setStringWidth(fame,' ',6)+setStringWidth(msg,' ',49),' ',80)+"|\n";
        }
        catch (Attributes.AttributeNotFoundException e) {}
      }
      ret+=middle;
