 ...
 * <p>  
 * The Network Manager is our router that sends and receives messages to and from the network. 
 * The manager exposes the interfaces that allow:<ul>
 ...
 *  
 * The Write method is immediate, just call it with the message to send, 
 * making sure that you have correctly filled SourceAddress and ClientID. 
 * The message will then be sent to the Client.
 * 
 * The Read method is blocking, when you call the Read method it either returns a 
 * message from the queue or if the queue is empty the thread blocks (sleeps) until 
 * one arrives.
 * 
 * @author miguel
 */
