...
public class LoadAllActiveCharactersCommand  extends DBCommandWithCallback {
	 ...
	 */
	public LoadAllActiveCharactersCommand(String username) {
		super();
	...
	public void execute(DBTransaction transaction) throws SQLException, IOException {
		characters = DAORegister.get().get(CharacterDAO.class).loadAllActiveCharacters(transaction, username);
		if (callback != null) {
	...
	public String toString() {
		return "LoadAllActiveCharactersCommand [username=" + username
