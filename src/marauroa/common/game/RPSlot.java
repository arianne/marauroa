/* $Id: RPSlot.java,v 1.15 2005/11/16 16:06:08 mtotz Exp $ */
/***************************************************************************
...
public class RPSlot implements marauroa.common.net.Serializable, Iterable<RPObject>
  ...
  /** Gets the object from the slot */
  public RPObject get(int objectId) throws RPObjectNotFoundException
    {
    try
      {
      for(RPObject object: objects)
  ...
  /** This method removes the object from the slot */
  public RPObject remove(int objectId) throws RPObjectNotFoundException
    {
    try
      {
      Iterator<RPObject> it=objects.iterator();
  ...
  public void readObject(marauroa.common.net.InputSerializer in) throws java.io.IOException, java.lang.ClassNotFoundException
    ...
    if(capacity>TimeoutConf.MAX_ARRAY_ELEMENTS)
      {
      throw new IOException("Illegal request of an list of "+capacity+" size");
      }
