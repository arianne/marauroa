/* $Id: MessageS2CCreateAccountACK.java,v 1.1 2005/12/20 16:09:47 arianne_rpg Exp $ */
/***************************************************************************
...
public class MessageS2CCreateAccountACK extends Message
  ...
  public String toString()
    {
    return "Message (S2C CreateAccount ACK) from ("+source.getAddress().getHostAddress()+") CONTENTS: ()";
    }
