...
public class TransferContent
  ...
  public void readREQ(marauroa.common.net.InputSerializer in) throws IOException, ClassNotFoundException
    {
    name=in.readString();
  ...
  public void readACK(marauroa.common.net.InputSerializer in) throws IOException, ClassNotFoundException
    {
    name=in.readString();
    ack=(in.readByte()==1);      
    }
  ...
  public void readFULL(marauroa.common.net.InputSerializer in) throws IOException, ClassNotFoundException
    {
    name=in.readString();
