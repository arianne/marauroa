/* $Id: PerceptionHandler.java,v 1.6 2006/01/19 19:56:47 arianne_rpg Exp $ */
/***************************************************************************
...
public class PerceptionHandler
  ...
  public void apply(MessageS2CPerception message, Map<RPObject.ID,RPObject> world_instance) throws Exception
    ...
    if(message.getTypePerception()==Perception.SYNC)
      ...
      if(previousPerceptions.size()==0)
      ...
      else if(message.getPerceptionTimestamp()-previousTimestamp>20)
        {
        synced=false;
        listener.onUnsynced();
        }
        ...
        {
        logger.info("Unsynced: trying to synchronize with new perceptions");
        }
      }
