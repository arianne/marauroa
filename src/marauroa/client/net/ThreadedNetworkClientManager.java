...
public final class ThreadedNetworkClientManager
  ...
  /** the logger instance. */
  private static final Logger logger = Log4J.getLogger(ThreadedNetworkClientManager.class);
  ...
  public ThreadedNetworkClientManager(String host, int port) throws SocketException
    {
