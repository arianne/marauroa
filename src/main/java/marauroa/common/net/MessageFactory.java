...
public class MessageFactory
{
   ...
   * the logger instance.
   */
  private static final marauroa.common.Logger LOGGER
          = Log4J.getLogger(Attributes.class);
  ...
  public Message getMessage(Map<String, Object> in) throws IOException
  {
    ...
    {
      LOGGER.warn("Message type [" + messageTypeIndex
              + "] is not registered in the MessageFactory");
      throw new IOException("Message type [" + messageTypeIndex
              + "] is not registered in the MessageFactory");
    }
  }
}
